...
export interface ChromaGridProps {
  ...
  fadeOut?: number;
  ease?: string;
  onCardClick?: (item: ChromaItem, idx: number) => void;
}
    ...
    >
      {items.map((c, i) => (
        <article
          ...
          onClick={() =>
            onCardClick ? onCardClick(c, i) : handleCardClick(c.url)
          }
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle at var(--x) var(--y), transparent 0%, rgba(0,0,0,0.3) 100%)",
        }}
      />
      <div
        ref={fadeRef}
