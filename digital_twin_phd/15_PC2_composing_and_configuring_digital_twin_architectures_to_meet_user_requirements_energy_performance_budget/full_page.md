...
3. Composing and Configuring Digital Twin Architectures to Meet User Requirements (Energy, Performance, Budget)
...
PC2  Digital Twin  Software Architecture  Design Space Exploration  Non-Functional Requirements  PhD
...
Sallou, A., Gauvain, J., Bourcier, B., & Combemale, J.R. (2020). Loop Aggregation for Approximate Scientific Computing. *ICCS*. <https://doi.org/10.1007/978-3-030-50417-5_11>
...
[Apply Now](mailto:johann.bourcier@univ-pau.fr?subject=Application%3A%20Composing%20and%20Configuring%20Digital%20Twin%20Architectures%20to%20Meet%20User%20Requirements%20(Energy%2C%20Performance%2C%20Budget))   [View All Positions](/en/join-us)