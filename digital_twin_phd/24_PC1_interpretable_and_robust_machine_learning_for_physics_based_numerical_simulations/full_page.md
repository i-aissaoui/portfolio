...
3. Interpretable and Robust Machine Learning for Physics-Based Numerical Simulations
...
**Email**: [fabrice.gamboa@math.univ-toulouse.fr](mailto:fabrice.gamboa@math.univ-toulouse.fr)

Co Supervisors
**Supervisor**: VALLEE Mathieu and Clément Gauchy
**Institution**: CEA LITEN and CEA ISAS
**Email**: [mathieu.vallee@cea.fr](mailto:mathieu.vallee@cea.fr) and [clement.gauchy@cea.fr](mailto:clement.gauchy@cea.fr)
...
Cholaquidis et al. (2023). Weighted lens depth: Some applications to supervised classification. *Canadian Journal of Statistics*. <https://doi.org/10.1002/cjs.11724>

[2]

Da Veiga et al. (2021). Basics and Trends in Sensitivity Analysis. *SIAM*.

[3]

Hallin et al. (2021). Distribution and quantile functions in dimension d: a measure transportation approach. <https://doi.org/10.1214/20-aos1996>

[4]

Nguyen et al. (2024). Combining statistical depth and Fermat distance for uncertainty quantification. *NeurIPS*. <https://doi.org/10.52202/079017-0951>

[5]

Yahiaoui et al. (2025). Reliable neural network model for accelerating coupled thermodiffusion simulation. *ICAPP*.
...
[Apply Now](mailto:fabrice.gamboa@math.univ-toulouse.fr?subject=Application%3A%20Interpretable%20and%20Robust%20Machine%20Learning%20for%20Physics-Based%20Numerical%20Simulations)   [View All Positions](/en/join-us)